...
<section className="w-full pt-20 pb-16 bg-[#003C3C] md:bg-gradient-to-r md:from-[#003C3C] md:via-[#005F5F] md:to-[#00AEEF]/90 text-white font-[Geist] relative overflow-hidden">
  ...
  {/* 🌟 Radial Glow */}
  <div className="absolute top-1/2 left-1/2 w-[1000px] h-[1000px] bg-[#00AEEF]/20 rounded-full blur-[120px] transform -translate-x-1/2 -translate-y-1/2 pointer-events-none z-0" />

  {/* 🔒 Base Background Reinforcement */}
  <div className="absolute inset-0 bg-[#003C3C] z-0" />

  {/* 🌊 Floating Wave Background */}
  <div className="hidden md:block absolute inset-0 z-0 overflow-hidden pointer-events-none animate-waveFloat">
    <svg
      className="w-full h-full"
      viewBox="0 0 1440 320"
      preserveAspectRatio="none"
  ...
  <div className="relative z-10 px-4 py-10 sm:py-16">
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10">
      ...
      {/* 🎟️ Ticket Image */}
      <div className="w-full md:w-1/2 flex justify-center items-center h-[600px]">
        <Image
          src="/airplane.png"
          alt="Ticket"
          width={500}
          height={400}
          className="max-w-[90%] sm:max-w-[440px] md:max-w-[520px] rounded-xl shadow-2xl border border-white/10 pulse-glow"
          priority
        />
      </div>
