...
{showCurrencyModal && (
 ...
 {/* Hero Content */}
<section className="relative z-10 px-4 py-8 sm:py-12 md:py-16 lg:py-20">
  <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-12 lg:gap-16">
    
    {/* 🌍 Text Left */}
    <div className="w-full md:w-1/2 text-center md:text-left">
      <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight mb-4 animate-fadeUp tracking-tight">
        Explore the World<br />
        with <span className="text-[#00AEEF]">Flyawoof</span><br />
        Today
      </h1>
      <p className="text-sm sm:text-base md:text-lg text-[#005f5f] mb-6 animate-fadeUp">
        Book smarter. Travel lighter.<br />
        Discover easier.
      </p>
      <button
        onClick={handleBookClick}
        className="group relative bg-white border border-[#00AEEF] text-[#00AEEF] px-5 py-3 sm:px-6 sm:py-3 md:px-8 md:py-4 rounded-full font-semibold text-sm sm:text-base md:text-lg hover:bg-[#00AEEF] hover:text-white transition-all animate-glow"
      >
    ...
    <div className="w-full md:w-1/2 flex justify-center">
      <Image
        ...
        width={500}
        height={400}
        className="max-h-[250px] sm:max-h-[300px] md:max-h-[400px] lg:max-h-[500px] w-auto h-auto animate-float"
        priority
      />
    </div>
